...
declare -a bundled_in_gi_ics_versions=(2 2)
...
cp4s_redis_release="1.6.11" # .ibm-pak/data/cases/ibm-cp-security/$CASE_VERSION/caseDependencyMapping.csv
...
edr_redis_release="1.6.11" # .ibm-pak/data/cases/ibm-security-edr/$CASE_VERSION/caseDependencyMapping.csv
