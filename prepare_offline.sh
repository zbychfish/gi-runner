...
[[ $script_argument -lt 1 ]] &&read -n 1 -s -r -p "Press any key to continue"
rm -rf $GI_TEMP/airgap/*
[[ $script_argument -lt 2 ]] && prepare_ocp
[[ $script_argument -lt 2 ]] && read -n 1 -s -r -p "Press any key to continue"
rm -rf $GI_TEMP/airgap/* $GI_TEMP/images $GI_TEMP/ocp-images.yaml
[[ $script_argument -lt 3 ]] && prepare_rook
[[ $script_argument -lt 3 ]] && read -n 1 -s -r -p "Press any key to continue"
rm -rf $GI_TEMP/airgap/*
[[ $script_argument -lt 4 ]] && prepare_addons
[[ $script_argument -lt 4 ]] && read -n 1 -s -r -p "Press any key to continue"
